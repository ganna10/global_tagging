...
all.data <- tbl_df(read.csv(file = "NOx_Monthly_assigned_MDA8_to_Tier2_regions.csv"))
...
plotting <- function (region, data.frame) {
  if (region == "SAS") {
    ...
    plot.title <- "South Asia: Monthly Average of O3 MDA8 for Emissions and Meteorology for Year 2010"    
  } else if (region == "NAM") {
    df <- data.frame %>%
    ...
    plot.title <- "North America: Monthly Average of O3 MDA8 for Emissions and Meteorology for Year 2010"
  } else if (region == "EUR") {
    df <- data.frame %>%
    ...
    plot.title <- "Europe: Monthly Average of O3 MDA8 for Emissions and Meteorology for Year 2010"
  } else if (region == "EAS") {
    df <- data.frame %>%
    ...
    plot.title <- "East Asia: Monthly Average of O3 MDA8 for Emissions and Meteorology for Year 2010"
  } else if (region == "MDE") {
    df <- data.frame %>%
    ...
    plot.title <- "Middle East: Monthly Average of O3 MDA8 for Emissions and Meteorology for Year 2010"
  } else if (region == "RBU") {
    df <- data.frame %>%
    ...
    plot.title <- "Russia, Belarus, Ukraine: Monthly Average of O3 MDA8 for Emissions and Meteorology for Year 2010"
  } else if (region == "OCN") {
    df <- data.frame %>%
    ...
    plot.title <- "Oceans: Monthly Average of O3 MDA8 for Emissions and Meteorology for Year 2010"
  } else if (region == "Rest") {
    df <- data.frame %>%
      filter(Region == "Rest")
    ...
    plot.title <- "Rest of the World: Monthly Average of O3 MDA8 for Emissions and Meteorology for Year 2010"
  } else {
    stop("No region")
  }
  ...
  p <- p + ggtitle(plot.title, subtitle = "\nTotal Ozone MDA8 (ppbv) and MDA8 from NOx Sources in Tier 2 Receptor Regions")
