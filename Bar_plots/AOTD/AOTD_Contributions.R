...
get.data <- function (month) {
  ...
  file.name <- paste0("/work/users/jco/tagging_global/Scripts/Tier2_Analysis/AOTD/Data/HTAP_AOTD_", month.text, "_assigned_to_Tier2_regions.csv")
...
title.base <- ": Monthly AOT40-D O3 for Emissions and Meteorology for Year 2010"
