...
get.data <- function (month) {
  ...
  file.name <- paste0(month.text, "-AOTD.csv")
...
assign.tag.text <- function (spc) {
  if (spc == "o3_95") {
    ...
    tag = "O3_X_BMB"
  } else if (spc == "namlbc_95") {
    tag = "O3_X_NAMLBC"
  } else if (spc == "saslbc_95") {
    tag = "O3_X_SASLBC"
  } else if (spc == "eurlbc_95") {
    tag = "O3_X_EURLBC"
  } else if (spc == "ocnlbc_95") {
    tag = "O3_X_OCNLBC"
  } else if (spc == "rbulbc_95") {
    tag = "O3_X_RBULBC"
  } else if (spc == "rstlbc_95") {
    tag = "O3_X_RSTLBC"
  } else {
    tag <- "No match"
  }
